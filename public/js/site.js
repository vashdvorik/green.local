(() => {
    const dictionary = {
        ru: {
            "meta.title": "Green Energy Hub",
            "menu.open": "Открыть меню",
            "menu.close": "Закрыть меню",
            "nav.home": "Главная",
            "nav.about": "О проекте",
            "nav.about.project": "О Green Energy Hub",
            "nav.about.mission": "Миссия и цели",
            "nav.about.directions": "Направления работы",
            ...
            "nav.news": "Новости",
            "nav.opportunities": "Тендеры",
            "nav.media": "Медиа",
            "nav.media.photo": "Фото",
            "nav.media.video": "Видео",
            "nav.media.catalogues": "Каталоги",
            "nav.partners": "Партнёры",
            "nav.cta": "Получить консультацию",
            "nav.contacts": "Контакты",
            "home.label": "Центр экспертизы и практических решений",
            "home.title": "Энергия, которую можно использовать лучше.",
            ...
            "home.business.copy": "Помогаем предприятиям понять структуру энергопотребления, выявить потери и выбрать решения, которые делают работу устойчивее.",
            "home.business.cta": "Для бизнеса",
            "home.metrics.label": "Green Energy Hub в цифрах",
            "home.metrics.title": "Только фактические результаты проекта.",
            "home.metrics.copy": "Показатели будут обновляться по мере реализации проекта.",
            "home.metrics.audit": "Проведено энергоаудитов",
            "home.metrics.business": "Предприятий получили рекомендации",
            "home.metrics.people": "Подготовлено специалистов",
            "home.metrics.events": "Проведено мероприятий",
            "home.metrics.materials": "Практических материалов",
            "home.metrics.cta": "Все результаты",
            "home.news.label": "Последние новости",
            "home.news.title": "Что происходит в хабе.",
            "home.news.cta": "Все новости",
            "home.read": "Подробнее",
            "home.opps.label": "Актуальные тендеры",
            "home.opps.title": "Тендеры, которыми можно воспользоваться сейчас.",
            "home.opps.cta": "Все тендеры",
            ...
            "home.partners.support": "При финансовой поддержке",
            ...
            "home.contact.cta": "Контакты",
            "placeholder.image": "Фото-заполнитель",
            "placeholder.date": "Дата",
            "placeholder.news1": "Заголовок новости проекта",
            "placeholder.news2": "Новая публикация Green Energy Hub",
            "placeholder.news3": "Практика, обучение и партнёрство",
            ...
            "footer.address": "Адрес: MD - 3000 Тирасполь ул. Свердлова 57",
            "footer.phone": "Телефон: 533 80988",
            "footer.email": "E-mail: info@education.md",
            "footer.copyright": "© Green Energy Hub",
            "footer.note": "Практика для устойчивого будущего",
        },
        ro: {
            "meta.title": "Green Energy Hub",
            ...
            "nav.home": "Acasă",
            "nav.about": "Despre proiect",
            "nav.about.project": "Despre Green Energy Hub",
            "nav.about.mission": "Misiune și obiective",
            "nav.about.directions": "Direcții de lucru",
            ...
            "nav.news": "Noutăți",
            "nav.opportunities": "Licitații",
            "nav.media": "Media",
            "nav.media.photo": "Foto",
            "nav.media.video": "Video",
            "nav.media.catalogues": "Cataloage",
            "nav.partners": "Parteneri",
            "nav.cta": "Solicită o consultație",
            "nav.contacts": "Contacte",
            "home.label": "Centru de expertiză și soluții practice",
            "home.title": "Energia poate fi înțeleasă și folosită mai bine.",
            ...
            "home.business.copy": "Ajutăm întreprinderile să înțeleagă consumul, să identifice pierderile și să aleagă soluții mai reziliente.",
            "home.business.cta": "Pentru afaceri",
            "home.metrics.label": "Green Energy Hub în cifre",
            "home.metrics.title": "Doar rezultatele reale ale proiectului.",
            "home.metrics.copy": "Indicatorii vor fi actualizați pe măsura implementării proiectului.",
            "home.metrics.audit": "Audituri energetice realizate",
            "home.metrics.business": "Întreprinderi cu recomandări",
            "home.metrics.people": "Specialiști instruiți",
            "home.metrics.events": "Evenimente realizate",
            "home.metrics.materials": "Materiale practice",
            "home.metrics.cta": "Toate rezultatele",
            "home.news.label": "Ultimele știri",
            "home.news.title": "Ce se întâmplă în hub.",
            "home.news.cta": "Toate știrile",
            "home.read": "Detalii",
            "home.opps.label": "Licitații actuale",
            "home.opps.title": "Licitații la care puteți participa acum.",
            "home.opps.cta": "Toate licitațiile",
            ...
            "home.partners.support": "Cu sprijinul financiar",
            ...
            "home.contact.cta": "Contacte",
            "placeholder.image": "Foto temporară",
            "placeholder.date": "Data",
            "placeholder.news1": "Titlul știrii proiectului",
            "placeholder.news2": "O nouă publicație Green Energy Hub",
            "placeholder.news3": "Practică, instruire și parteneriat",
            ...
            "footer.address": "Adresă: MD - 3000 Tiraspol, str. Sverdlov, 57",
            "footer.phone": "Telefon: 533 80988",
            "footer.email": "E-mail: info@education.md",
            "footer.copyright": "© Green Energy Hub",
            "footer.note": "Practică pentru un viitor durabil",
        },
        en: {
            "meta.title": "Green Energy Hub",
            "menu.open": "Open menu",
            ...
            "nav.home": "Home",
            "nav.about": "About",
            "nav.about.project": "About Green Energy Hub",
            "nav.about.mission": "Mission and goals",
            "nav.about.directions": "What we do",
            ...
            "nav.news": "News",
            "nav.opportunities": "Tenders",
            "nav.media": "Media",
            "nav.media.photo": "Photos",
            "nav.media.video": "Videos",
            "nav.media.catalogues": "Catalogues",
            "nav.partners": "Partners",
            "nav.cta": "Get a consultation",
            "nav.contacts": "Contact",
            "home.label": "Expertise and practical solutions",
            "home.title": "Energy can be understood and used better.",
            ...
            "home.business.copy": "We help enterprises understand their energy use, find losses and choose solutions that make operations more resilient.",
            "home.business.cta": "For business",
            "home.metrics.label": "Green Energy Hub in numbers",
            "home.metrics.title": "Only the project's actual results.",
            "home.metrics.copy": "Indicators will be updated as the project is implemented.",
            "home.metrics.audit": "Energy audits completed",
            "home.metrics.business": "Businesses with recommendations",
            "home.metrics.people": "Specialists trained",
            "home.metrics.events": "Events held",
            "home.metrics.materials": "Practical resources",
            "home.metrics.cta": "All results",
            "home.news.label": "Latest news",
            "home.news.title": "What is happening at the hub.",
            "home.news.cta": "All news",
            "home.read": "Read more",
            "home.opps.label": "Current tenders",
            "home.opps.title": "Tenders you can take part in now.",
            "home.opps.cta": "All tenders",
            ...
            "home.partners.support": "With financial support",
            ...
            "placeholder.news1": "Project news headline",
            "placeholder.news2": "A new Green Energy Hub publication",
            "placeholder.news3": "Practice, training and partnership",
            ...
            "footer.address": "Address: MD - 3000 Tiraspol, 57 Sverdlov Street",
            "footer.phone": "Phone: 533 80988",
            "footer.email": "Email: info@education.md",
            "footer.copyright": "© Green Energy Hub",
            "footer.note": "Practice for a resilient future",
        },
    };
    ...
    function setLanguage(language) {
        ...
        try {
            ...
            // Language switching still works if storage is disabled.
        }
    }
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        try {
            savedLanguage = localStorage.getItem(storageKey) || "ru";
        } catch (error) {
        ...
        if (heroPhoto && !reducedMotion.matches) {
            ...
            const updateHeroParallax = () => {
                ...
                const heroCenter = bounds.top + (bounds.height / 2);
                const distance = (viewportCenter - heroCenter) / (window.innerHeight + bounds.height);
                const limit = window.innerWidth < 768 ? 10 : 18;
                const offset = Math.max(-limit, Math.min(limit, distance * limit * 2));
                heroPhoto.style.setProperty("--hero-parallax", `${offset.toFixed(2)}px`);
                parallaxFrame = null;
            };
        ...
        const menuLabel = menuButton.querySelector("[data-i18n]");
        let menuScrollPosition = 0;
        const dropdowns = [...menu.querySelectorAll("[data-dropdown]")];
        ...
        const updateMenuState = (isOpen) => {
            ...
            if (menuLabel) {
                menuLabel.dataset.i18n = isOpen ? "menu.close" : "menu.open";
                menuLabel.textContent = dictionary[document.documentElement.dataset.locale || "ru"][menuLabel.dataset.i18n];
            }
        };
